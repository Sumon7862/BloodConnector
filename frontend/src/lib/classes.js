...
export const btnOutline =
  'inline-flex h-9 items-center justify-center rounded-lg border border-brand px-3.5 text-[13px] font-bold text-brand transition hover:bg-rose-50 dark:hover:bg-brand/15'

export const cardClass =
  'rounded-[14px] border border-slate-200 bg-white shadow-[0_10px_30px_rgba(17,24,39,0.08)] dark:border-slate-700 dark:bg-panel dark:shadow-[0_18px_48px_rgba(0,0,0,0.45)]'
